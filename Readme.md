<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/134074490/10.2.3%2B)
...
<p>Starting from version 10.2.3, it is necessary to add the ConstantValue class to the known service types.</p>
